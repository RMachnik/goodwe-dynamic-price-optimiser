...
timing_awareness:
  smart_critical_charging:
    ...
    partial_charging:
      ...
      session_tracking_file: '/opt/goodwe-dynamic-price-optimiser/out/partial_charging_sessions.json'  # Production path
...
3. **Monitor session tracking file** creation at `/opt/goodwe-dynamic-price-optimiser/out/partial_charging_sessions.json`
...
3. Check session file: `cat /opt/goodwe-dynamic-price-optimiser/out/partial_charging_sessions.json`

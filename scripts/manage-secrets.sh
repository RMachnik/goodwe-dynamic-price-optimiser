...
echo "🔐 Securely configuring secrets for $TARGET..."
echo "   Host: $HOST"
echo ""
...
echo "✅ Configuration successfully written to $REMOTE_DIR/$ENV_FILE on $TARGET."
echo "⚠️  Restart the service for changes to take effect."
